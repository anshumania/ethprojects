...
public class CommentsJpaController {
    ...
    public void create(Comments comments) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            Designs designs = comments.getDesigns();
            if (designs != null) {
    ...
    public void edit(Comments comments) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            Users usersOld = persistentComments.getUsers();
            Users usersNew = comments.getUsers();
            Designs designsOld = persistentComments.getDesigns();
            Designs designsNew = comments.getDesigns();
            if (usersNew != null) {
