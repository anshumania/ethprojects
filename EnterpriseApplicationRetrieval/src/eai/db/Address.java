...
public class Address {
    ...
    public static PreparedStatement getViewStatement(Connection con) throws SQLException {
        return con.prepareStatement("SELECT a.address_id, a.customer_id, a.street, a.city, a.zip_code, c.country_name FROM " + getTableName() + " as a, " + Country.getTableName() + " as c WHERE a.country_id = c.country_id AND a.customer_id = ?");
    }
    ...
    public static PreparedStatement getDeleteStatement(Connection con) throws SQLException {
        return con.prepareStatement("DELETE FROM " + getTableName() + " WHERE customer_id = ? AND address_id = ?");
    }
