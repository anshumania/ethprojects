...
@MessageDriven(mappedName = "jms/CompanyTasks", activationConfig = {
    ...
    @ActivationConfigProperty(propertyName = "clientId", propertyValue = "LocalOfficeTwoz"),
    @ActivationConfigProperty(propertyName = "subscriptionName", propertyValue = "LocalOfficeTwoz")
})
public class LocalOfficeTwoz implements MessageListener {
    ...
    public LocalOfficeTwoz() {
    }

    public void onMessage(Message message) {
        System.out.println("received in office2");
        ...
        try {
            ...
            if (localOfficeStatus.contains("office2")) {
...
//              message.setStringProperty("task_status", "Finishing in " + runTime);
                        ...
                        if (taskStatus.equals("not_started")) {
                            localOfficeStatus = "office2_AVAILABLE";
                        }
                        //message.setStringProperty("localOffice_status", "office1_AVAILABLE");
                    }
                } else {
                    localOfficeStatus = "office2_BUSY";
                }
//                message.setStringProperty("localOffice_status", "office1_BUSY");
    ...
    public void doWork(long runTime) {
        Runnable runWork = new TaskWork("office2", runTime);
